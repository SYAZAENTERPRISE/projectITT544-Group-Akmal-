...
<div class="brands index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                <td><?= $this->Number->format($brand->brandID) ?></td>
                <td><?= h($brand->brandName) ?></td>
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $brand->brandID]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $brand->brandID]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $brand->brandID], ['confirm' => __('Are you sure you want to delete # {0}?', $brand->brandID)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
